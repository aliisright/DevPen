<form method="post" action="{{ Route('profiles.update', [$userId]) }}">
  ...
  <div class="form-group">
    ...
    <input type="date" name="birth_date" class="form-control {{ $errors->has('birth_date') ? 'is-invalid' : '' }}" id="birth_date" placeholder="ex: 01/07/1993 (jour/mois/année)">
  </div>
